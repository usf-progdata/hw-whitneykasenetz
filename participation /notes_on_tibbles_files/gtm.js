...
"resource": {
  ...
  "rules":[
    ...
    [["if",43],["add",28]],
    [["if",40,44],["add",31]],
    [["if",8,40],["unless",45,46],["add",31]],
    [["if",40,47],["add",31]],
    [["if",40,45],["unless",44],["add",32]],
    [["if",42,49],["add",32]],
    [["if",50,51],["add",33]],
    [["if",40,48],["add",38],["block",31]],
    [["if",11,52],["add",41]],
    [["if",40,53],["add",42]],
    [["if",54,55,56],["add",44]],
    [["if",57,58],["add",45]]]
...
var Eg=[J.C,J.K],Fg=function(a){var b=a[J.gd];b&&K(40);var c=a[J.De];c&&K(41);for(var d=Va(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==J.gd&&f!==J.De)if(-1<Wa(Eg,f)){var g=f,h=a[f],l=d[e];pg().set(g,h,l,"US","US-FL",c)}else{}},Gg=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
10>E;E++){var I=u[E].element,P=u[E].ed,Q=!1;C.push({ed:P,querySelector:kh(I),tagName:I.tagName,isVisible:!Qg(I),type:1,Sc:!!Q})}return{elements:C,status:D}};var pe={},O=null,Bh=Math.random();pe.F="GTM-PLVRLF";pe.Ec="2h0";pe.$i="";pe.pg="ChAIgNXigQYQlPmthZ3g49xyEiMAZBHMTE+wuPVmNDKhBQIkJtc3LCHVpFlRc/dNHlLBxb9LfBoCs4o\x3d";var Ch={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Dh={__paused:!0,__tg:!0},Eh;for(Eh in Ch)Ch.hasOwnProperty(Eh)&&(Dh[Eh]=!0);var Fh="www.googletagmanager.com/gtm.js";
var Gh=Fh,Hh=jb(""),Ih=null,Jh=null,Kh="//www.googletagmanager.com/a?id="+pe.F+"&cv=149",Lh={},Mh={},Nh=function(){var a=O.sequence||1;O.sequence=a+1;return a};var Oh={},Ph=new $a,Qh={},Rh={},Uh={name:"dataLayer",set:function(a,b){G(xb(a,b),Qh);Sh()},get:function(a){return Th(a,2)},reset:function(){Ph=new $a;Qh={};Sh()}},Th=function(a,b){return 2!=b?Ph.get(a):Vh(a)},Vh=function(a,b){var c=a.split(".");b=b||[];for(var d=Qh,e=0;e<c.length;e++){if(null===d)return!1;if(void 0===d)break;d=d[c[e]];if(-1!==Wa(b,d))return}return d},Wh=function(a,b){Rh.hasOwnProperty(a)||(Ph.set(a,b),G(xb(a,b),Qh),Sh())},Sh=function(a){cb(Rh,function(b,c){Ph.set(b,c);G(xb(b,
...
Y.h.awc=["nonGoogleScripts"],function(){var a=!1;(function(b){Y.__awc=b;Y.__awc.i="awc";Y.__awc.m=!0;Y.__awc.priorityOverride=0})(function(b){if(a)b.vtp_gtmOnSuccess();else{var c=b.vtp_channel||"na",d,e,f;if(b.vtp_group&&0<=b.vtp_group.indexOf(":")){d=b.vtp_group;for(var g=b.vtp_group.split("|"),h=[],l=f=0;l<g.length;l++)if(g[l]){var m=g[l].split(":");if(2==m.length&&m[0]&&m[1]){var n=parseFloat(m[1]);isNaN(n)||(h.push(W(m[0])+
":"+n),f+=n)}}e=h.join("|")}else f=b.vtp_orderValue||0,d=(b.vtp_group||"DEFAULT")+":"+f,e=W(b.vtp_group||"DEFAULT")+":"+W(f);var q=b.vtp_testMode?"1":"0";try{var u=["merchant="+W(b.vtp_merchantId),"ref="+W(b.vtp_orderRef),"amount="+W(f),"parts="+e,"ch="+W(c),"testmode="+q];b.vtp_currency&&u.push("cr="+W(b.vtp_currency));b.vtp_discountCode&&u.push("vc="+W(b.vtp_discountCode));os("https://www.awin1.com/sread.img?tt=ns&tv=2&"+u.join("&"))}catch(t){}try{var r={};r.orderRef=b.vtp_orderRef;r.amount=f;b.vtp_currency&&
(r.currency=b.vtp_currency);r.parts=d;b.vtp_discountCode&&(r.voucher=b.vtp_discountCode);r.channel=c;r.test=q;p.AWIN={Tracking:{Sale:r}};S("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a=!0}catch(t){N(b.vtp_gtmOnFailure)}}})}();
